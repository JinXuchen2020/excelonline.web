...
import { IGroupRspModel, IGroupManagerStatusRspModel, ISaleStatusReqModel, ICourseRspModel, IGroupManagerCourseReqModel, IUserQueryOption, IGroupManagerLiteRspModel, IGroupManagerStatusLiteRspModel, ISaleStatusRspModel, IGroupManagerStatusListRspModel } from "models";
...
const Api = { 
  ...
  addGroupManager: (groupManager: ISaleStatusReqModel) => ({ method: "POST", url: `groupManagers`, body: groupManager} as IFetchProps),
  updateGroupManager: (id: string, groupManager: ISaleStatusReqModel) => ({ method: "PUT", url: `groupManagers/${id}`, body: groupManager} as IFetchProps),
...
export const GroupService = {
  ...
  getGroupManagerStatusDetail: async (id: string) => $fetch<ISaleStatusRspModel>(Api.getGroupManagerStatusDetail(id)),
  addGroupManager: async (groupManager: ISaleStatusReqModel) => $fetch(Api.addGroupManager(groupManager)),
  updateGroupManager: async (id: string, groupManager: ISaleStatusReqModel) => $fetch(Api.updateGroupManager(id, groupManager)),
